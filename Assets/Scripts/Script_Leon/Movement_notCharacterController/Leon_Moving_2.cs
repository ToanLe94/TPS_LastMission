...
public class Leon_Moving_2 : MonoBehaviour {
    ...
    void Turn()
    {
        if (_speed>0)
        {
            ...
            transform.Rotate(0.0f, Input.GetAxis("Horizontal") *2, 0.0f);
            //transform.eulerAngles = Vector3.up * Mathf.SmoothDamp(transform.eulerAngles.y, cameraT.eulerAngles.y, ref curr, 1.2f);
