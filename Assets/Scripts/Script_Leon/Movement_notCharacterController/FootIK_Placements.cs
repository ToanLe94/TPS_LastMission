    ...
    void OnAnimatorIK()
    {
        ...
        if (Physics.Raycast(shootRay_rightfoot, out shootHit_rightfoot))
        {
            ...
            if (shootHit_rightfoot.collider.tag == "Stair")
            {
                ...
                //Debug.DrawRay(shootHit_rightfoot.point, shootHit_rightfoot.normal, Color.yellow);


                //Debug.Log("tranform up cau player" + transform.up);
                //Quaternion xoay = Quaternion.FromToRotation(transform.up, shootHit_rightfoot.normal);
                //Debug.Log("xoay duoc bao nhieu do" + xoay.eulerAngles);
                //Quaternion saunhan = xoay * transform.rotation;
                //Debug.Log("xoay duoc bao nhieu do sau nhan voi rotation" + saunhan.eulerAngles);

                //Quaternion test1 = Quaternion.Euler(0, 20, 0);
                //Quaternion test2 = Quaternion.Euler(10, 10, 10);
                //Quaternion test3 =  test1 * test2 ;
                //Debug.Log("gia tri nhan 2 quaterion ::::::::::::::::::::::::::::" + test3.eulerAngles);
